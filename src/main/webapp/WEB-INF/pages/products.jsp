          ...
          <table style="background: transparent" class="table is-bordered is-narrow is-fullwidth has-text-white">
            ...
            <c:forEach var="product" items="${products}">
              <tr>
                ...
                <td>${product.price}</td>
                <td><a class="has-text-success has-text-centered"
                       href="${pageContext.request.contextPath}/shop/product?product_id=${product.id}">See
                  Product</a></td>
                <td>
                  <form action="shop/products" method="post">
                    ...
                    <div class="field" style="text-align: center">
                      <input class="input is-inline" value="1" type="number" min="1" max="100" name="quantity" placeholder="1">
