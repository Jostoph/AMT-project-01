...
public class UsersDAO implements IUsersDAO {
    ...
    public User create(User entity) throws DuplicateKeyException {
        ...
        try {
            ...
            PreparedStatement statement = con.prepareStatement("INSERT INTO amt_users (USERNAME, EMAIL, HASHED_PW) VALUES (?, ?, ?)");
            statement.setString(1, entity.getUsername());
            statement.setString(2, entity.getEmail());
            statement.setString(3, authenticationService.hashPassword(entity.getPwHash()));
            statement.execute();
            return entity;
   ...
   /* @Override
    public User findById(String username) throws KeyNotFoundException{
        ...
        try {
            con = dataSource.getConnection();
            PreparedStatement statement = con.prepareStatement("SELECT USERNAME, EMAIL FROM user WHERE USERNAME = ?");
